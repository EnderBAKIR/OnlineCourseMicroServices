...
namespace FreeCouse.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                new ApiScope("catalog_fullpermission","Catalog Apisine Full Erişim"),
                ...
                new ApiScope("gateway_fullpermission","Gateway Apisine Full Erişim"),
